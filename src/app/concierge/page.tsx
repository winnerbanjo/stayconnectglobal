      ...
      <main className="pt-28 pb-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {CONCIERGE_SERVICES.map((srv, idx) => {
            const Icon = srv.icon;
            return (
              <div key={idx} className="bg-[#1A1918] border border-[#2C2B29] rounded-2xl p-6 space-y-3 hover:border-[#00AEEF]/50 transition-colors">
                <div className="w-10 h-10 rounded-xl bg-[#252422] border border-[#3A3935] flex items-center justify-center text-[#00AEEF]">
        ...
        <div className="bg-[#1A1918] border border-[#2C2B29] rounded-3xl p-6 sm:p-10 shadow-2xl">
          {submitted ? (
            <div className="text-center py-12 space-y-4">
              <CheckCircle2 className="w-12 h-12 text-[#00AEEF] mx-auto" />
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  <label className="text-xs text-[#00AEEF] font-semibold">Service Required *</label>
                  <select
                ...
                <div className="space-y-1.5">
                  <label className="text-xs text-[#00AEEF] font-semibold">Guest Name *</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs text-[#00AEEF] font-semibold">Preferred Date & Time *</label>
                ...
                <div className="sm:col-span-2 space-y-1.5">
                  <label className="text-xs text-[#00AEEF] font-semibold">Special Instructions or Notes</label>
