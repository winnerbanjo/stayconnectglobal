              ...
              {rooms.map((rm, idx) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-xs text-[#C6A15B] underline"
                  >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <span className="text-xs font-serif text-[#C6A15B] font-bold">
              ...
              <form onSubmit={handleCreateRoom} className="space-y-4 text-xs">
                ...
                <label className="block">
                  ...
                  <select
                    ...
                    className="w-full p-3 bg-black border border-[#444] rounded-lg mt-2"
                  >
                    {properties.map((p) => (
