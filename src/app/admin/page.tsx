...
export default function AdminPage() {
  const [bookings, setBookings] = useState<Booking[]>([
    ...INITIAL_BOOKINGS,
    {
      ...
      adults: 2,
      children: 0,
      guestName: 'Barrister Femi Adeniyi',
      guestEmail: 'femi@adeniyilaw.ng',
      guestPhone: '+234 704 100 8351',
      country: 'Nigeria',
      specialRequests: 'Walk-In guest from Lekki Phase 1 front desk',
      subtotal: 370000,
      taxesAndFees: 46250,
      discountAmount: 0,
      totalPrice: 416250,
      ...
      <aside className="w-64 border-r border-[#2C2B29] p-6 flex flex-col justify-between hidden md:flex shrink-0">
        ...
        <div className="pt-6 border-t border-[#2C2B29] space-y-3">
          <div className="text-[10px] text-neutral-400">
            WhatsApp Hotline: <span className="text-[#C6A15B] font-mono font-medium">+234 704 100 8351</span>
          </div>
