                ...
                <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-[#2C2B29] flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xl font-semibold text-[#00AEEF]">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 bg-[#00AEEF] hover:bg-[#d8b46e] text-[#111111] font-semibold text-xs rounded-lg transition-colors flex items-center gap-1.5"
                    >
