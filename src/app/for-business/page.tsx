      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 mb-20">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="px-8 py-4 border border-[#2C2B29] hover:border-[#00AEEF] text-white font-medium text-xs uppercase tracking-[0.2em] rounded-xl transition-all"
            >
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-16 border-t border-[#2C2B29]">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#00AEEF] font-semibold">Why Hospitality Partners Join</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {BUSINESS_SOLUTIONS.map((sol, idx) => {
              const Icon = sol.icon;
              return (
                <div key={idx} className="bg-[#1A1918] border border-[#2C2B29] rounded-2xl p-8 space-y-4 hover:border-[#00AEEF]/50 transition-colors">
                  <div className="w-12 h-12 rounded-xl bg-[#252422] border border-[#3A3935] flex items-center justify-center text-[#00AEEF]">
