        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-3">
              <span className="text-xs uppercase tracking-[0.35em] text-[#00AEEF] font-semibold flex items-center gap-2">
            ...
            <blockquote className="font-serif italic text-lg md:text-xl text-neutral-300 border-l-2 border-[#00AEEF] pl-6 py-1">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-[#2C2B29]">
              <div className="space-y-1">
                <div className="font-serif text-3xl text-[#00AEEF] font-medium">100%</div>
                <div className="text-xs uppercase tracking-widest text-neutral-400">Power & Fiber Uptime</div>
              </div>
              <div className="space-y-1">
                <div className="font-serif text-3xl text-[#00AEEF] font-medium">24 / 7</div>
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute -bottom-8 -left-6 sm:left-6 bg-[#1A1918] border border-[#00AEEF]/40 p-6 rounded-xl shadow-2xl max-w-xs text-white backdrop-blur-md">
