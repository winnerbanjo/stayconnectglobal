...
export default function PartnerCTASection() {
  return (
    <section className="py-20 sm:py-28 bg-gradient-to-b from-[#161514] via-[#111111] to-[#0A0A0A] text-white border-t border-[#2C2B29] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#00AEEF]/5 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="bg-[#1A1918] border border-[#00AEEF]/40 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-6 flex flex-col sm:flex-row items-center gap-4">
                ...
                <Link
                  href="/for-business"
                  className="w-full sm:w-auto px-8 py-4 rounded-xl border border-[#2C2B29] hover:border-[#00AEEF] text-neutral-300 hover:text-white font-medium text-xs uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2"
                >
            ...
            <div className="lg:col-span-5">
              <div className="bg-[#111111] border border-[#2C2B29] rounded-2xl p-6 sm:p-8 space-y-6 shadow-2xl">
                <div className="flex items-center justify-between border-b border-[#2C2B29] pb-4">
                  <div className="text-xs font-semibold text-[#00AEEF] uppercase tracking-wider">Partner Benefits Overview</div>
                  <TrendingUp className="w-5 h-5 text-[#00AEEF]" />
                </div>

                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-3 rounded-xl bg-[#1A1918]">
                    <Globe className="w-6 h-6 text-[#00AEEF] shrink-0 mt-1" />
                    <div>
                  ...
                  <div className="flex items-start gap-4 p-3 rounded-xl bg-[#1A1918]">
                    <Shield className="w-6 h-6 text-[#00AEEF] shrink-0 mt-1" />
                    <div>
                  ...
                  <div className="flex items-start gap-4 p-3 rounded-xl bg-[#1A1918]">
                    <Users className="w-6 h-6 text-[#00AEEF] shrink-0 mt-1" />
                    <div>
