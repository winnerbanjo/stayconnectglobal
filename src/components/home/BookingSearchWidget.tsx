  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (activeTab === "stays") {
      if (!checkIn || !checkOut || checkOut <= checkIn) {
        alert("Choose a check-out date after check-in.");
        return;
      }
                ...
                <>
                  <div className="space-y-1 lg:col-span-3">
                    ...
                    >
                      ...
                      <option value="Mercedes G-Wagon G63">
                        Mercedes G-Wagon G63
                      </option>
                      <option value="Rolls-Royce Cullinan">
                        Rolls-Royce Cullinan
                      </option>
                      <option value="Toyota Land Cruiser">
                        Toyota Land Cruiser VIP
                      </option>
                    </select>
                  </div>
              ...
              {activeTab === "transfers" && (
                <>
                  <div className="space-y-1 lg:col-span-4">
                    ...
                    >
                      <option value="Lagos">
                        Murtala Muhammed Int'l Airport (LOS)
                      </option>
                      <option value="Abuja">
                        Nnamdi Azikiwe Int'l Airport (ABV)
                      </option>
                      <option value="Port Harcourt">
                        Port Harcourt Int'l Airport (PHC)
                      </option>
                    </select>
                  </div>
                ...
                <>
                  <div className="space-y-1 lg:col-span-5">
                    ...
                    <select
                      ...
                      className="w-full min-h-[44px] bg-white dark:bg-[#111111] border border-[#E8E5DF] dark:border-[#2C2B29] rounded-xl px-3 py-2 text-xs text-[#111111] dark:text-white"
                    >
                      <option value="Private Chef Service">
                        Private Chef Service
                      </option>
                      <option value="VIP Security & Escort">
                        VIP Security & Escort
                      </option>
                      <option value="Yacht Lagoon Cruise">
                        Private Yacht Cruise
                      </option>
                      <option value="Proposal Setup">
