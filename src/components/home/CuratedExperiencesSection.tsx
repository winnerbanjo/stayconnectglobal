              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-4 border-t border-[#2C2B29]">
                  <Link
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-lg border border-[#00AEEF] text-xs font-semibold text-[#00AEEF] hover:bg-[#00AEEF] hover:text-[#111111] transition-all"
                  >
