          ...
          {TRUST_CARDS.map((card, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-[#1A1918] border border-[#E8E5DF] dark:border-[#2C2B29] hover:border-[#00AEEF]/60 rounded-2xl p-6 sm:p-8 space-y-4 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1"
              >
                <div className="w-12 h-12 rounded-xl bg-[#FAF9F6] dark:bg-[#252422] border border-[#E8E5DF] dark:border-[#3A3935] flex items-center justify-center text-[#00AEEF]">
